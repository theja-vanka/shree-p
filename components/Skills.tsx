...
export default function Skills() {
  ...
  return (
    <section id="skills" className="section mx-auto max-w-content px-6 py-20">
      <Reveal>
        <div className="grid gap-10 md:grid-cols-[200px_1fr]">
          ...
          />
          <div className="max-w-2xl rounded-2xl border border-black/5 bg-white/60 p-6">
              ...
              {content.skills.map((group, i) => {
                ...
                return (
                  <div key={group.category}>
                    ...
                    <div className={`mt-2 h-2 w-full overflow-hidden rounded-full ${style.track}`}>
                      <div
